...
class IdCardsZipper(object):
    def __init__(self, air_waybill_id):
        ...
        self.base_path = os.path.join(settings.MEDIA_ROOT, "id_export/")
        ...
        for waybill in waybills:
            ...
            if people and people.id_card:
                try:
                    ...
                    # 写入excel
                    b_index += 1
                    sheet['B%d' % b_index] = waybill.cn_tracking if waybill.cn_tracking else ''
                except Exception as e:
                    a_index += 1
                    sheet['A%d' % a_index] = waybill.cn_tracking if waybill.cn_tracking else ''
